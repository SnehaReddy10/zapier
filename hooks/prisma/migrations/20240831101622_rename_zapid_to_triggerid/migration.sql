/*
  ...
  - You are about to drop the column `zapId` on the `HookReq` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "HookReq" DROP CONSTRAINT "HookReq_zapId_fkey";

-- AlterTable
ALTER TABLE "HookReq" DROP COLUMN "zapId",
